...
rocky = Dog.create(:owner => charlotte, :name => "Rocky", :age => 3, :breed => "Pugle", :description => "athletic little monster", :temperament => "adorable, crazy, stubborn", :active => "very active", :housetrained => true, :picture => true, :special_needs => "none") 
